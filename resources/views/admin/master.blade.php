                ...
                $.ajax({
                    ...
                    if(response.length > 0){
                        ...
                        $.each(response, function(index, value){
                            ...
                            }else if(value.jenis_file == 'dda'){
                                $('.slimscroll.noti-scroll').append('<a href="{{ route("sektoral.file") }}?id=' + value.opd_id + '&opd_file_id='+ value.id_notifikasi + '" class="dropdown-item notify-item border-bottom"><div class="notify-icon bg-primary"><i class="uil uil-user-plus"></i></div><p class="notify-details">(DDA) <small class="text-muted">Anda menerima file dari ' + value.name +'</small></p></a>')
                            }else{
