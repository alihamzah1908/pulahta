...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>PULLAHTA MAINTENANCE</title>
    ...
    <body class="authentication-bg">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-5 col-8">
                        <div class="text-center">
                            ...
                            <div>
                                <img src="{{ asset('new-assets/images/maintenance.svg') }}" alt="" class="img-fluid" />
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <h4 class="mt-5">We are currently performing maintenance</h4>
                            <p class="text-muted">We're making the system more awesome. <br/> We'll be back at 12.00 PM / 24.00 WIB.</p>
                    </div>
                </div>
        ...
        <!-- App js -->
        <script src="{{ asset('new-assetsassets/js/app.min.js') }}"></script>
